...
<template>
    <a-typography-title class="title">防汛水位表</a-typography-title>
    ...
    <div class="content">
        <a-row class="flex-c">
            <a-col>
                <a-card style="width:300px" title="三线水位记录情况登记表1">
                    <p>1、 今日 8:00 水位</p>
                    <p>2、 昨日 8:00 水位</p>
                    <p>3、 上周同期 8:00 水位</p>
                    <p>4、 去年同期 8:00 水位</p>
            ...
            <a-col>
                <a-card style="width:300px" clss="card" title="三线水位记录情况登记表2">
                    <p>1、 当前整点时间对应水位</p>
                    <p>2、 4小时前整点时间对应水位</p>
                    <p>3、 8小时前整点时间对应水位</p>
                    <a-divider />
            ...
            <a-col>
                <a-card style="width:300px" title="三线水位记录情况登记表3">
                    <p>1、 当前整点时间对应水位</p>
                    <p>2、 4小时前整点时间对应水位</p>
                    <p>3、 8小时前整点时间对应水位</p>
                    <a-divider />
        ...
        <a-typography-title :level="3">小提示：</a-typography-title>
